    ...
    <div className="card card-hover flex flex-col md:flex-row gap-8 md:gap-12 items-center h-full p-6 md:p-8">
      ...
      <div className="flex-1 relative order-1 md:order-2 w-full">
        <div className="relative">
          <div className="aspect-[4/3] bg-gray-50 rounded border border-gray-100 p-5 flex flex-col justify-between">
            <div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="rounded bg-white border border-gray-100 p-3">
          ...
          {/* Info Badge */}
          <div className="absolute -bottom-4 -right-4 md:right-6 md:bottom-6 bg-primary p-5 rounded shadow-lg max-w-[180px]">
