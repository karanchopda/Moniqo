    ...
    <div className="card card-hover h-full p-6 md:p-8 overflow-hidden">
      <div className="grid grid-cols-1 md:grid-cols-[0.9fr_1.1fr] gap-8 h-full">
        <div className="flex flex-col">
          <div className="w-14 h-14 rounded bg-accent/10 flex items-center justify-center text-accent mb-6">
        ...
        <div className="rounded border border-outline-variant bg-surface-container-low p-4 sm:p-5 flex flex-col gap-4">
          <div className="rounded bg-white border border-outline-variant p-4 max-w-[82%]">
            <p className="text-sm font-semibold text-primary leading-relaxed">
              How much did I spend on Swiggy this month?
            </p>
          </div>

          <div className="rounded bg-primary text-white p-4 sm:p-5 ml-auto max-w-[92%]">
          ...
          <div className="grid grid-cols-3 gap-3 mt-auto">
            {['Vendor', 'Category', 'Time range'].map((item) => (
              <div key={item} className="rounded bg-white border border-outline-variant px-3 py-2 text-center">
