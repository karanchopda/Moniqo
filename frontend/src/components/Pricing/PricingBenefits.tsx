...
export default function PricingBenefits() {
  ...
  return (
    <section className="px-8 pb-32 max-w-[1550px] mx-auto flex flex-col md:flex-row gap-12">
      {benefits.map((benefit, i) => (
        <motion.div 
          ...
          viewport={{ once: true }}
          className="flex-1 bg-primary/5 border border-primary/5 p-16 rounded-[4rem] flex flex-col md:flex-row items-center md:items-start gap-10 hover:border-accent/30 transition-all duration-700"
        >
          ...
          <div className="flex-1 text-center md:text-left">
            <h4 className="text-3xl font-headline font-black text-primary mb-6 tracking-tighter">{benefit.title}</h4>
