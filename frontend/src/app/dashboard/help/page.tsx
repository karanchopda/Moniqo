...
export default function HelpPage() {
  ...
  return (
    <div className="space-y-8 pb-4 font-sans">
      ...
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#0c2f24] via-[#094030] to-[#0a5c43] p-10 md:p-14 text-center text-white shadow-lg border border-emerald-950/20">
        ...
        <div className="relative z-10 space-y-6 max-w-2xl mx-auto">
          ...
          <div className="flex bg-white rounded-full p-1.5 shadow-md items-center max-w-xl mx-auto border border-gray-100">
            <input 
              type="text" 
            ...
            />
            <button className="flex items-center gap-1.5 bg-[#0a5c43] hover:bg-[#084b36] text-white px-5 py-2 rounded-full text-xs font-black transition-colors shadow-sm shrink-0">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white border border-gray-200/80 rounded-2xl p-6 shadow-sm flex flex-col justify-between space-y-5 hover:shadow-md transition-all">
          <div className="space-y-4">
            <div className="w-10 h-10 rounded-xl bg-emerald-50 text-[#0a5c43] flex items-center justify-center border border-emerald-100 shadow-sm">
        ...
        <div className="bg-[#3b5e4c] text-white rounded-2xl p-6 shadow-md flex flex-col justify-between space-y-5 border border-emerald-950/20">
          <div className="space-y-4">
            <div className="w-10 h-10 rounded-xl bg-white/10 text-[#4df2aa] flex items-center justify-center shadow-inner">
      ...
      <div className="space-y-4 pt-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
          ...
          <div className="lg:col-span-8 rounded-2xl relative overflow-hidden h-[300px] shadow-sm border border-gray-200 flex flex-col justify-end p-6">
            ...
            <div className="relative z-10 space-y-2 text-white">
              <span className="inline-block bg-[#2ebd75] text-white px-2.5 py-0.5 rounded-md text-[9px] font-black uppercase tracking-wider">
                Video Guide
              </span>
          ...
          <div className="lg:col-span-4 bg-white border border-gray-200 rounded-2xl p-6 shadow-sm flex flex-col justify-between space-y-6">
            <div className="space-y-4">
              ...
              <div className="space-y-4 text-xs font-bold text-gray-500 leading-normal">
                ...
                <div className="flex gap-3 items-start">
                  <div className="w-5 h-5 rounded-full bg-gray-100 flex items-center justify-center text-[10px] font-black text-primary shrink-0">1</div>
                  <p>Use <span className="text-primary font-black">‘Cmd + K’</span> to open the global search from anywhere.</p>
                </div>
                {/* Tip 2 */}
                <div className="flex gap-3 items-start">
                  <div className="w-5 h-5 rounded-full bg-gray-100 flex items-center justify-center text-[10px] font-black text-primary shrink-0">2</div>
                  <p>Connect more than 3 banks to unlock <span className="text-[#0a5c43] font-black">"Deep Portfolio Insights"</span>.</p>
                </div>
              </div>
            </div>

            <button className="w-full py-2.5 bg-white border border-gray-200 hover:bg-gray-50 text-gray-600 rounded-xl font-bold text-xs transition-colors text-center shadow-sm">
              See all tips
            </button>
          </div>
      ...
      <div className="bg-[#e6f4ee] rounded-2xl p-8 text-center space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-2xl mx-auto">
          ...
          {/* Card 1: Live Chat */}
          <div className="bg-white border border-gray-200/60 p-4 rounded-xl shadow-sm flex items-center justify-between hover:border-[#0a5c43]/40 cursor-pointer transition-colors group">
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-full bg-[#e6f4ee] text-[#0a5c43] flex items-center justify-center">
