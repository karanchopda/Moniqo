        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_auto] lg:items-center">
          ...
          <div className="grid grid-cols-2 gap-3 sm:w-[260px]">
            ...
            <div className="rounded-md border border-brand-border-green-light bg-white px-4 py-3 text-center">
              ...
              <p className="mt-1 text-2xl font-black text-brand-dark">PDF</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="mt-6 overflow-hidden rounded-md border border-brand-border-gray bg-white shadow-[0_8px_22px_rgba(15,23,42,0.03)]">
        <div className="flex flex-col gap-3 border-b border-brand-border-light px-6 py-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <button
            ...
            className="inline-flex h-10 items-center justify-center gap-2 rounded-md border border-brand-border px-4 text-sm font-bold text-primary"
          >
        ...
        {loading ? (
          ...
          <div className="px-6 py-16 text-center">
            ...
            <Link href="/dashboard" className="mt-3 inline-flex items-center gap-2 text-sm font-black text-brand-green-text-alt">
              Go to dashboard
              ...
              <div key={statement.id} className="grid gap-4 px-6 py-4 sm:grid-cols-[1fr_auto] sm:items-center">
                <div className="flex min-w-0 items-center gap-3">
                  ...
                  <div className="min-w-0">
                    <p className="truncate text-sm font-black text-brand-dark">{statement.filename}</p>
