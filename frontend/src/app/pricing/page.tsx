...
export default function PricingPage() {
  return (
    <div className="bg-white min-h-screen flex flex-col font-body text-primary selection:bg-accent/30 selection:text-primary overflow-hidden scroll-smooth transition-colors duration-500 relative">
      <div className="absolute top-[-5%] left-[-5%] w-[60%] h-[50%] bg-accent/5 rounded blur-[150px] pointer-events-none"></div>
      <div className="absolute bottom-0 right-[-10%] w-[40%] h-[40%] bg-primary/5 rounded blur-[120px] pointer-events-none"></div>
