...
export default function PricingPage() {
  return (
    <div className="bg-white min-h-screen flex flex-col font-body text-primary selection:bg-accent/30 selection:text-primary overflow-x-hidden scroll-smooth transition-colors duration-500 relative">
